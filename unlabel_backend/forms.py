...
class UpdateProductForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # help text
        self.fields['campaign_type'].help_text = '''

        Choose campaign if you'd like to have content created and promoted by creators via their unlabel.us profile and social media networks. 
        If select non-campaign your products will only be promoted by creators via their unlabel.us profile and no content will be created.
